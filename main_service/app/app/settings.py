...
SECRET_KEY = 'django-insecure-7)e1$d=^*b=)v^75*$q@s_@2^jvakzzvdfg_$(n@s*m3q-q&)q'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ["172.31.0.2", "127.0.0.1", detection_service_ip, grouping_service_ip, image_processing_ip]
